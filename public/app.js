const shoes = [
  { id: 1, name: 'Classic Running Pro', price: 129.99, category: 'men', image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&h=400&fit=crop', rating: 4.5, reviews: 128, description: 'High-performance running shoe', features: ['Breathable mesh', 'Memory foam', 'Lightweight'] },
  { id: 2, name: 'Elegant Step Heels', price: 159.99, category: 'women', image: 'https://images.unsplash.com/photo-1597805212624-bc7d8f3da4a6?w=400&h=400&fit=crop', rating: 4.7, reviews: 95, description: 'Sophisticated heels for formal events', features: ['Premium leather', 'Cushioned', 'Anti-slip'] },
  { id: 3, name: 'Bounce Kids Sneaker', price: 79.99, category: 'kids', image: 'https://images.unsplash.com/photo-1560343090-19c0bae08e38?w=400&h=400&fit=crop', rating: 4.6, reviews: 156, description: 'Colorful and durable sneakers', features: ['Lightweight', 'Velcro strap', 'Flexible'] },
  { id: 4, name: 'Urban Explorer Boot', price: 189.99, category: 'men', image: 'https://images.unsplash.com/photo-1543163521-9efcc06b9558?w=400&h=400&fit=crop', rating: 4.8, reviews: 87, description: 'Rugged outdoor boot', features: ['Waterproof', 'Ankle support', 'Treaded'] },
  { id: 5, name: 'Comfort Casual Flat', price: 89.99, category: 'women', image: 'https://images.unsplash.com/photo-1548526881-7612dc8af359?w=400&h=400&fit=crop', rating: 4.4, reviews: 142, description: 'Versatile flat for everyday wear', features: ['Soft insole', 'Flexible', 'Easy clean'] },
  { id: 6, name: 'Neon Play Sneaker', price: 84.99, category: 'kids', image: 'https://images.unsplash.com/photo-1460353581641-37baddab0fa2?w=400&h=400&fit=crop', rating: 4.5, reviews: 203, description: 'Bright fun sneakers for kids', features: ['Vibrant colors', 'Washable', 'Breathable'] }
];
